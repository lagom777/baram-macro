...
def create_ui():
    ...
    tk.Label(root, text="right ctrl: 동동주 먹고 공력증강(동동주 u에 둘 것)", font=("Arial", 12), fg="blue").pack(pady=5)
    tk.Label(root, text="pause: tab", font=("Arial", 12), fg="blue").pack(pady=5)
    tk.Label(root, text="/: 탭탭으로 격수 힐(탭으로 격수 잡아놓을 것)", font=("Arial", 12), fg="blue").pack(pady=5)
    tk.Label(root, text="*: 힐 반복 - F2실행 후 실행", font=("Arial", 12), fg="blue").pack(pady=5)
    tk.Label(root, text="-: 본인 회복시키기", font=("Arial", 12), fg="blue").pack(pady=5)
    tk.Label(root, text="0: 혼마돌리기", font=("Arial", 12), fg="blue").pack(pady=5)
